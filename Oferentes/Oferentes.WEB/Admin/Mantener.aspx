    ...
    <div class="row no-gutter">
        <div class="col-sm-4 col-sm-offset-4 form-group">
            ...
            <asp:UpdatePanel ID="UpdatePanel34" runat="server">
                <ContentTemplate>
                    <asp:DropDownList ID="ddlDNI" runat="server" CssClass="form-control" ClientIDMode="Static" AutoPostBack="True" DataTextField="ident" DataValueField="num_dni" OnSelectedIndexChanged="ddlDNI_SelectedIndexChanged">
