        ...
        <asp:TabContainer ID="Talento" runat="server" ActiveTabIndex="0" Height="800px" Style="margin-top: 0px">        
            <asp:TabPanel runat="server" HeaderText="Talentos" ID="tpTalentos">
                ...
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rvReporteTalento" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="988px" Height="740px">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="Oferentes.WEB.dsDirectorioTableAdapters.sp_Talento_search_dni_ubigeo_activ_lugar_activ_orgTableAdapter">
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="txtInicio" DefaultValue="01/01/2014" Name="fecharegini" PropertyName="Text" Type="String" />
                            <asp:ControlParameter ControlID="txtFin" Name="fecharegfin" PropertyName="Text" Type="String" DefaultValue="31/12/2020" />
                        </SelectParameters>
            ...
            <asp:TabPanel ID="tpExp" runat="server" HeaderText="Experiencias">
                ...
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvReportExp" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="990px" Height="740px">
            ...
            <asp:TabPanel ID="tdTalentoporActiv" runat="server" HeaderText="Actividad por Talento">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvTalentoporActiv" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="988px" Height="740px">
            ...
            <asp:TabPanel ID="tpTalentoporOrg" runat="server" HeaderText="Organización por Talento">

                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvTalentoporOrg" runat="server" Width="987px" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="740px">
            ...
            <asp:TabPanel ID="tpActivporOrg" runat="server" HeaderText="Actividades por Organización" Visible="False">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvActivporOrg" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="991px" Height="740px">
            ...
            <asp:TabPanel ID="tpGraficos" runat="server" HeaderText="Gráficos">
                ...
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvGrafico" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="740px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="988px">
            ...
            <asp:TabPanel ID="tpActivAnio" runat="server" HeaderText="Registro Tal x Activ">

                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvActivporAnio" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="990px" Height="740px">
            ...
            <asp:TabPanel ID="tpOrgporAnio" runat="server" HeaderText="Registro de Tal x Org">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvOrgporAnio" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="988px" Height="740px">
            ...
            <asp:TabPanel ID="tpDeptporAnio" runat="server" HeaderText="Registro de Tal x lugActiv">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvDeptporAnio" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="988px" Height="740px">
